...
class TestFile(unittest.TestCase):
    def setUp(self) -> None:
        self.file = DataSelector.loader.File(path="resources/testFile.csv")
        self.file.readCSV()
    ...
    def test_loadJSON(self):
        self.file = DataSelector.loader.File(path="resources/testFile.json")
        self.file.readJSON()
    ...
    def test_emptyFile(self):
        test_file = DataSelector.loader.File(path="resources/emptyFile.csv")
